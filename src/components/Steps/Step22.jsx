...
const Step22 = ({ formData, updateFormData, onNext, onBack }) => {
    ...
    const renderBoilerForm = (boilerNum) => {
        ...
        return (
            <div key={boilerNum} style={{ border: '1px solid #ccc', padding: '10px', marginBottom: '20px', borderRadius: '8px' }}>
                ...
                <br /> */}
                <div className='quest'>Тип котлов</div>
                <label>
                    <input
                        type="radio"
                ...
                <label>
                    <input
                        ...
                        name={`pipeBranch_${boilerNum}`}
                        value="Атмосферный"
                        checked={boiler.pipeBranch === "Атмосферный"}
                        onChange={(e) => handleFieldChange(boilerNum, 'pipeBranch', e.target.value)}
                    />
                    Атмосферный
                </label>
                ...
                <label>
                    <input
                        type="radio"
                        name={`pipeBranch_${boilerNum}`}
                        value="Конденсационный"
                        checked={boiler.pipeBranch === "Конденсационный"}
                        onChange={(e) => handleFieldChange(boilerNum, 'pipeBranch', e.target.value)}
                    />
                    Конденсационный
                </label>
                ...
                <label>
                    <input
                        type="radio"
                        name={`pipeBranch_${boilerNum}`}
                        value="С избыточным давлением не конденсационный"
                        checked={boiler.pipeBranch === "С избыточным давлением не конденсационный"}
                        onChange={(e) => handleFieldChange(boilerNum, 'pipeBranch', e.target.value)}
                    />
                ...
                <label>
                    <input
                        type="radio"
                        name={`pipeBranch_${boilerNum}`}
                        value="С высоким давлением до 5000 Па (ДГУ ГПУ КГУ ГТУ)"
                        checked={boiler.pipeBranch === "С высоким давлением до 5000 Па (ДГУ ГПУ КГУ ГТУ)"}
                        onChange={(e) => handleFieldChange(boilerNum, 'pipeBranch', e.target.value)}
                    />
                    С высоким давлением до 5000 Па (ДГУ ГПУ КГУ ГТУ)
                </label>
